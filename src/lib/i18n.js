...
const DICT = {
  es: {
    ...
    "cs.recolor.title": "Recolorear con un esquema",
    "cs.recolor.placeholder": "Pegá CSS, variables, config de Tailwind o cualquier texto con colores (HEX, rgb, hsl)…",
    "cs.recolor.noColors": "Pegá colores (CSS / HEX / rgb / hsl) para usarlos como referencia.",
    "cs.recolor.apply": "Aplicar esquema",
    "cs.recolor.help": "Mapea la imagen a los colores del esquema según la luminosidad de cada píxel (gradient map).",
    "cs.scheme.title": "Esquema de color (listo para el proyecto)",
    "cs.scheme.from": "Generar desde:",
    "cs.scheme.help": "Escalas 50–900 por rol (primary, secondary, accent, neutral) y tokens semánticos (success, warning, error, info), a partir de la paleta que elijas arriba (Antes = imagen original; Después = resultado). Clic en un tono para copiarlo.",
  ...
  en: {
    ...
    "cs.recolor.title": "Recolor with a scheme",
    "cs.recolor.placeholder": "Paste CSS, variables, a Tailwind config or any text with colors (HEX, rgb, hsl)…",
    "cs.recolor.noColors": "Paste colors (CSS / HEX / rgb / hsl) to use them as reference.",
    "cs.recolor.apply": "Apply scheme",
    "cs.recolor.help": "Maps the image onto the scheme's colors based on each pixel's lightness (gradient map).",
    "cs.scheme.title": "Color scheme (project-ready)",
    "cs.scheme.from": "Generate from:",
    "cs.scheme.help": "50–900 scales per role (primary, secondary, accent, neutral) and semantic tokens (success, warning, error, info), from the palette you pick above (Before = original image; After = result). Click a shade to copy it.",
  ...
  pt: {
    ...
    "cs.recolor.title": "Recolorir com um esquema",
    "cs.recolor.placeholder": "Cole CSS, variáveis, config do Tailwind ou qualquer texto com cores (HEX, rgb, hsl)…",
    "cs.recolor.noColors": "Cole cores (CSS / HEX / rgb / hsl) para usá-las como referência.",
    "cs.recolor.apply": "Aplicar esquema",
    "cs.recolor.help": "Mapeia a imagem para as cores do esquema conforme a luminosidade de cada pixel (gradient map).",
    "cs.scheme.title": "Esquema de cor (pronto para o projeto)",
    "cs.scheme.from": "Gerar a partir de:",
    "cs.scheme.help": "Escalas 50–900 por papel (primary, secondary, accent, neutral) e tokens semânticos (success, warning, error, info), a partir da paleta escolhida acima (Antes = imagem original; Depois = resultado). Clique num tom para copiá-lo.",
    "cs.scheme.css": "Copiar CSS",
    "cs.scheme.tailwind": "Copiar Tailwind",
