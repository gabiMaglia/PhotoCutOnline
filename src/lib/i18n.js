...
const DICT = {
  es: {
    ...
    "edit.watermark": "Marca de agua",
    "edit.annotate": "Anotar",
    "edit.source": "Partir de",
    "edit.srcOriginal": "Original",
    "edit.srcCutout": "Recorte",
    ...
    "faces.dragHint": "Arrastrá sobre la foto para tapar una zona a mano.",
    "faces.manualHint": "También podés arrastrar sobre la foto para tapar cualquier zona (patentes, datos, lo que sea).",
    ...
    "filters.preset": "Filtro",
    "filters.none": "Original",
    "filters.bw": "B&N",
    "filters.sepia": "Sepia",
    "filters.vivid": "Vívido",
    "filters.soft": "Suave",
    "filters.brightness": "Brillo — {n}",
    "filters.contrast": "Contraste — {n}",
    "filters.saturation": "Saturación — {n}",
    "filters.reset": "Restablecer",
    "filters.download": "Descargar",
    "filters.help": "Se aplica en tu navegador — la foto no se sube.",
    "wm.title": "Marca de agua",
    "wm.placeholder": "© Tu marca",
    "wm.opacity": "Opacidad — {n}",
    "wm.size": "Tamaño — {n}",
    "wm.angle": "Ángulo — {n}°",
    "wm.density": "Separación — {n}",
    "wm.color": "Color",
    "wm.download": "Descargar con marca",
    "wm.help": "Repite tu marca en diagonal sobre toda la foto. Se aplica en tu navegador, sin subir la imagen.",
    "annot.title": "Anotar",
    "annot.shape": "Forma",
    "annot.arrow": "Flecha",
    "annot.rect": "Recuadro",
    "annot.ellipse": "Elipse",
    "annot.line": "Línea",
    "annot.width": "Grosor — {n}",
    "annot.color": "Color",
    "annot.undo": "Deshacer",
    "annot.clear": "Limpiar",
    "annot.download": "Descargar anotada",
    "annot.help": "Arrastrá sobre la foto para dibujar flechas, recuadros y elipses. Ideal para señalar cosas en una captura. Todo en tu navegador.",
    "annot.emptyBody": "Abrí una foto y arrastrá para dibujar flechas o recuadros y señalar lo que quieras, sin subir la imagen.",
    "wm.emptyBody": "Abrí una foto y escribí tu marca para repetirla sobre toda la imagen (protección de autoría), sin subir nada.",
    "filters.emptyBody": "Abrí una foto para aplicar un filtro (blanco y negro, sepia, vívido) y ajustar brillo, contraste y saturación, sin subir la imagen.",
  ...
  en: {
    ...
    "edit.source": "Start from",
    "edit.srcOriginal": "Original",
    "edit.srcCutout": "Cutout",
    ...
    "faces.dragHint": "Drag over the photo to hide an area by hand.",
    "faces.manualHint": "You can also drag over the photo to hide any area (license plates, data, anything).",
    "faces.help": "Detection runs 100% in your browser — the photo is never uploaded. Great for hiding faces before sharing.",
    "filters.title": "Filters & adjust",
    ...
    "filters.vivid": "Vivid",
    "filters.soft": "Soft",
    "filters.brightness": "Brightness — {n}",
    "filters.contrast": "Contrast — {n}",
    "filters.saturation": "Saturation — {n}",
    "filters.reset": "Reset",
    "filters.download": "Download",
    "filters.help": "Applied in your browser — the photo is never uploaded.",
    "wm.title": "Watermark",
    "wm.placeholder": "© Your brand",
    "wm.opacity": "Opacity — {n}",
    "wm.size": "Size — {n}",
    "wm.angle": "Angle — {n}°",
    "wm.density": "Spacing — {n}",
    "wm.color": "Color",
    "wm.download": "Download watermarked",
    "wm.help": "Repeats your mark diagonally across the whole photo. Applied in your browser, without uploading the image.",
    "annot.title": "Annotate",
    "annot.shape": "Shape",
    "annot.arrow": "Arrow",
    "annot.rect": "Box",
    "annot.ellipse": "Ellipse",
    "annot.line": "Line",
    "annot.width": "Thickness — {n}",
    "annot.color": "Color",
    "annot.undo": "Undo",
    "annot.clear": "Clear",
    "annot.download": "Download annotated",
    "annot.help": "Drag over the photo to draw arrows, boxes and ellipses. Great for pointing things out on a screenshot. All in your browser.",
    "annot.emptyBody": "Open a photo and drag to draw arrows or boxes and point things out, without uploading the image.",
    "wm.emptyBody": "Open a photo and type your mark to tile it across the whole image (authorship protection), without uploading anything.",
    "filters.emptyBody": "Open a photo to apply a filter (black & white, sepia, vivid) and adjust brightness, contrast and saturation, without uploading the image.",
  ...
  pt: {
    ...
    "faces.dragHint": "Arraste sobre a foto para ocultar uma área à mão.",
    "faces.manualHint": "Você também pode arrastar sobre a foto para ocultar qualquer área (placas, dados, o que for).",
    ...
    "filters.vivid": "Vívido",
    "filters.soft": "Suave",
    "filters.brightness": "Brilho — {n}",
    "filters.contrast": "Contraste — {n}",
    "filters.saturation": "Saturação — {n}",
    "filters.reset": "Restaurar",
    "filters.download": "Baixar",
    "filters.help": "Aplicado no seu navegador — a foto não é enviada.",
    "wm.title": "Marca de água",
    "wm.placeholder": "© Sua marca",
    "wm.opacity": "Opacidade — {n}",
    "wm.size": "Tamanho — {n}",
    "wm.angle": "Ângulo — {n}°",
    "wm.density": "Espaçamento — {n}",
    "wm.color": "Cor",
    "wm.download": "Baixar com marca",
    "wm.help": "Repete a sua marca na diagonal por toda a foto. Aplicado no seu navegador, sem enviar a imagem.",
    "annot.title": "Anotar",
    "annot.shape": "Forma",
    "annot.arrow": "Seta",
    "annot.rect": "Retângulo",
    "annot.ellipse": "Elipse",
    "annot.line": "Linha",
    "annot.width": "Espessura — {n}",
    "annot.color": "Cor",
    "annot.undo": "Desfazer",
    "annot.clear": "Limpar",
    "annot.download": "Baixar anotada",
    "annot.help": "Arraste sobre a foto para desenhar setas, retângulos e elipses. Ideal para apontar coisas numa captura. Tudo no seu navegador.",
    "annot.emptyBody": "Abra uma foto e arraste para desenhar setas ou retângulos e apontar o que quiser, sem enviar a imagem.",
    "wm.emptyBody": "Abra uma foto e escreva a sua marca para repeti-la por toda a imagem (proteção de autoria), sem enviar nada.",
    "filters.emptyBody": "Abra uma foto para aplicar um filtro (preto e branco, sépia, vívido) e ajustar brilho, contraste e saturação, sem enviar a imagem.",
