...
const DICT = {
  es: {
    ...
    "cs.scheme.help": "Generado desde la paleta del resultado: escalas 50–900 por rol (primary, secondary, accent, neutral) y tokens semánticos (success, warning, error, info). Clic en un tono para copiarlo.",
  ...
  en: {
    ...
    "cs.scheme.help": "Generated from the result palette: 50–900 scales per role (primary, secondary, accent, neutral) and semantic tokens (success, warning, error, info). Click a shade to copy it.",
  ...
  pt: {
    ...
    "cs.scheme.help": "Gerado a partir da paleta do resultado: escalas 50–900 por papel (primary, secondary, accent, neutral) e tokens semânticos (success, warning, error, info). Clique num tom para copiá-lo.",
    "cs.scheme.css": "Copiar CSS",
    "cs.scheme.tailwind": "Copiar Tailwind",
